-- Engagement: Disengage action and opportunity attack tracking.
...
GRANT EXECUTE ON FUNCTION public.record_combat_disengage(UUID) TO authenticated;
...
SET combat_state = jsonb_set(
  combat_state,
  '{turn,disengageUsed}',
  COALESCE(combat_state #> '{turn,disengageUsed}', 'false'::jsonb),
  TRUE
)
