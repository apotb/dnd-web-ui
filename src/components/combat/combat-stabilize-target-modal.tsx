...
interface CombatStabilizeTargetModalProps {
  allies: CombatToken[];
...
export function CombatStabilizeTargetModal({
  allies,
  resolvePortraitUrl,
  onSelect,
  onCancel,
}: CombatStabilizeTargetModalProps) {
  return (
    <div className="supply-picker-overlay" onClick={onCancel}>
      ...
      >
        ...
        <p className="retro-muted">
          Choose a dying ally within 5 feet to stabilize.
        </p>
